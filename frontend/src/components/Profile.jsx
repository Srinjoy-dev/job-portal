      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
        ...
        <div className="my-5">
          ...
          <div className="flex items-center gap-1">
            {user?.profile?.skills.length != 0 ? user?.profile?.
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          {isResume ? (
            <a target="blank" href="https://github.com/Srinjoy-dev" className="text-blue-500 w-full hover:underline cursor-pointer">{user?.profile?.resumeOriginalName}</a>
          ) : (
            <span>NA</span>
          )}
        </div>
